<template>
    <div>
        <div class="netease-mini-player" data-theme="auto" :data-playlist-id="playlistId" data-embed="false"
            data-position="bottom-left" data-size="standard">
        </div>
    </div>
</template>
...
const playlistId = ref('9861368212')
