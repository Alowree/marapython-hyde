...
>
	...
	<div class="p-6 pt-4 relative z-10">
		...
		<div class="mb-4">
			<div
				class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[var(--btn-regular-bg)] text-black/70 dark:text-white/70 text-sm mb-3"
			>
				<svg
					class="w-4 h-4"
					xmlns="http://www.w3.org/2000/svg"
...
export const devicesData: DeviceCategory = {
	iPhone: [
		{
			name: "iPhone 17 Pro",
			image: "https://store.storeimages.cdn-apple.com/1/as-images.apple.com/is/iphone-17-pro-finish-select-202509-6-3inch_AV3?wid=5120&hei=2880&fmt=webp&qlt=90&.v=NUNzdzNKR0FJbmhKWm5YamRHb05tUzkyK3hWak1ybHhtWDkwUXVINFc0SEZjdHMrZjlMUFIvTnplV2VSS1lKS2xjZnhHRHJyenVmME5KTm9Sd1ZaU3NqbWRhTGpRM2xxVWJRWUhSaDlCQ3JhK0xFSk9TYUgyeDFHNDJKZ3BRelFRRXB6YUhNcms5Z1pYZXdkbUhocnBn&traceId=1",
			specs: "深蓝色 / 12G + 256G",
			description:
				"创新设计，打造巅峰性能和超长续航",
